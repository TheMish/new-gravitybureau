...
class BlogEntry extends Page {
	...
	function getCMSFields() {
		...
		$fields->addFieldToTab("Root.Meta", $dateField = new DatetimeField("Date", _t("BlogEntry.DT", "Date")));
		...
		$fields->addFieldToTab("Root.Meta", new TextField("Tags", _t("BlogEntry.TS", "Tags (comma sep.)")));
		
		$fields->addFieldToTab("Root.Meta", new UploadField("PostImage", "Post Thumbnail Image"));
