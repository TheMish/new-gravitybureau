...
$scope->locally()->obj('Staff', null, true); $scope->pushScope(); while (($key = $scope->next()) !== false) {
$val .= '
	';

if ($scope->locally()->hasValue('Visible', null, true)) { 
$val .= '
		<div class="stafftile-wrapper unit size1of5 ">
		
			<div class="stafftile" style="background-color:#000">
				<div class="staffimage"><img src="';

$val .= $scope->locally()->obj('Image', null, true)->XML_val('URL', null, true);
$val .= '" /></div>
				<div class="staffhover"><img src="';

$val .= $scope->locally()->obj('ImageAlt', null, true)->XML_val('URL', null, true);
$val .= '" height="100%" /></div>
				<h1>';
...
$val .= '</h1>
			...
			<div class="staffdetails">
				<ul>
					<li><h6><span class="serif">FULL TIME</span> ';

$val .= $scope->locally()->XML_val('JobTitle', null, true);
$val .= '</h6></li>
					<li><h6><span class="serif">PART TIME</span> ';

$val .= $scope->locally()->XML_val('PartTime', null, true);
$val .= '</h6></li>
				</ul>
			</div>
...
$val .= $scope->locally()->XML_val('Join', null, true);
$val .= '
		</div>
	</div>
...
$val .= $scope->locally()->XML_val('Hire', null, true);
$val .= '
		</div>
	</div>
...
$val .= '/images/One-Sheet.pdf" target="_blank"><img src="themes/gb/images/icon-onepage.png" height="50"></a>
		</div>
	</div>
...
<div class="section map" id="map">
	...
	<div class="unit sizeFull nopadding key">
		<div class="size1of5 unit"><img class="floatL" src="';

$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-map1.png" width="50" /><h6 class="floatL">Office Locations</h6></div>
		<div class="size1of5 unit"><img class="floatL" src="';

$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-map2.png" width="50" /><h6 class="floatL">Client Locations</h6></div>
		<div class="size1of5 unit"><img class="floatL" src="';

$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-map3.png" width="50" /><h6 class="floatL">Vacation Destinations</h6></div>
		<div class="size1of5 unit"><img class="floatL" src="';

$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-map4.png" width="50" /><h6 class="floatL">Yearly Flight Paths</h6></div>
		<div class="size1of5 unit"><img class="floatL" src="';

$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-map5.png" width="50" /><h6 class="floatL">Country of Origin</h6></div>
	</div>
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/stat-slide-1.jpg); background-size:cover;" id="drinking">
				<div class="container">
					<div class="content">
						...
						<div class="inner">
							...
							<div class="size1of4 unit">
								<div class="stat">
									...
									<img class="preserve" src="';

$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-coffee.png" />
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-other-drink.png" />
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/stat-slide-2.jpg);" id="eating">
				<div class="container">
					<div class="content">
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/stat-slide-3.jpg);" id="listening">
				<div class="container">
					<div class="content">
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-thehorrors.png" />
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/stat-slide-4.jpg);" id="watching">
				<div class="container">
					<div class="content">
...
$val .= $scope->locally()->XML_val('ThemeDir', null, true);
$val .= '/images/icon-truedetective.png" />
